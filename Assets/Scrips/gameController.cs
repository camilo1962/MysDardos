...
public class gameController : MonoBehaviour {
    ...
    public Mode mode;
    public int numeroTiradas = 6;
    public TMP_Text _numeroTiradas;
    ...
    void Update ()
    {
        ...
        _numeroTiradas.text = numeroTiradas.ToString();
        if(numeroTiradas == 0)
        {
            GameOver();
        }
    ...
    public void GameOver()
    {
        ...
        mode = Mode.Main;
        if (P1Score > P2Score)
            textoGanador.text = "Han ganado " + "Primer Jugador";
        else
            textoGanador.text = "Han ganado " + "Segundo Jugador";
        GuardarDatos();
    }
