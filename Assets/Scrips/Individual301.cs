...
public class Individual301 : MonoBehaviour
{
    ...
    public GameObject panelGameOverFull;
	...
	void Start ()
    {
        ...
        panelGameOverFull.SetActive(false);
    }
            ...
            else if(mode == Mode.MainMotion && progress == 0)
            {
                ...
                if (Physics.Raycast(Camera.main.ScreenPointToRay(Input.mousePosition), out hit))
                {
                    ...
                    if (P1Turn)
                    {
                        ...
                        StatusTxt.text = /*"Anotaste un:<i>" +*/ score.Points + " </i>puntos."; 
                    }


                    //StatusTxt.text +=  score.Points + " </i>puntos.";
    ...
    public void GameOver()
    {
        ...
        finalText.text = " Has conseguido <i>" + P1Score+ "</i> puntos.";
      
    }
    public void GameOverFull()
    {
        mode = Mode.Main;
        panelGameOverFull.SetActive(true);
        finalText.text = " Has PALMAO " + P1Score;
